...
<html>
<head>
  <title>Upcoming Habits - Habit Tracker</title>
  <style>
    ...
    .nav-buttons a { color: white; text-decoration: none; padding: 8px 16px; border-radius: 8px; margin-left: 12px; background: rgba(255,255,255,0.1); transition: background 0.2s; }
    ...
    .btn { padding: 8px 16px; border: none; border-radius: 6px; text-decoration: none; font-size: 0.9rem; cursor: pointer; transition: background 0.2s; }
